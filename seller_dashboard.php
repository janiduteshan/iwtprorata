...
<body>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <section class="inquiries-received-section p-6 bg-white rounded-lg shadow-lg">
            <h2 class="text-2xl font-semibold mb-6 text-gray-700 border-b pb-3">My Property Inquiries</h2>
            <div class="space-y-4">
                <?php
                if (isset($conn) && isset($_SESSION['userID'])) {
                    $seller_id = $_SESSION['userID'];
                    ...
                    if ($stmt_inquiries) {
                        ...
                        if ($result_inquiries->num_rows > 0) {
                            ...
                            echo "<p class='text-center text-gray-500 py-8'>You have not received any inquiries for your properties yet.</p>";
                        }
