...
<style>
/* Reusing styles similar to seller_dashboard.php */
.page-container { padding-top: 20px; padding-bottom: 20px; }
.agent-dashboard-page h1 { margin-bottom: 10px; font-size: 2.2em; color: #333; }
.agent-dashboard-page > p { margin-bottom: 20px; font-size: 1.1em; }
...
.listings-table .actions .btn-status.btn-available { background-color: #28a745; } /* Green for "Mark Available" */
